# 评测报告 - external_bipia_email_indirect_v4
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| rules_only | 1.000 | 0.768 | 0.869 | 0.000 | 0.232 | 0.330 | 1.24 |
| rules_classifier | 1.000 | 0.880 | 0.936 | 0.000 | 0.120 | 0.435 | 3.27 |
| full_stack | 1.000 | 0.880 | 0.936 | 0.000 | 0.120 | 0.435 | 3.18 |
| context_hardened_v3 | 1.000 | 0.973 | 0.986 | 0.000 | 0.027 | 0.486 | 3.23 |
...
| --- | --- | --- | --- | --- |
| en | 1.000 | 0.973 | 0.986 | 800 |

### 重点语言场景矩阵

| 切片 | 样本数 | Precision | Recall | F1 |
| --- | --- | --- | --- | --- |
| English indirect injection | 750 | 1.000 | 0.973 | 0.986 |
