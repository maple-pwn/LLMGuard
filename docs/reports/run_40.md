...
- 攻击/对抗样本：`1500`
- 白样本：`100`
- 攻击类型分布：`{'benign': 100, 'indirect_prompt_injection': 1500}`
...
| rules_classifier | 1.000 | 0.937 | 0.968 | 0.000 | 0.063 | 0.489 | 3.25 |
| full_stack | 1.000 | 0.937 | 0.968 | 0.000 | 0.063 | 0.489 | 3.35 |
| context_hardened_v3 | 1.000 | 1.000 | 1.000 | 0.000 | 0.000 | 0.485 | 3.30 |
