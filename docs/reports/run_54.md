# 评测报告 - zh_mixed_benchmark_v3_eval
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| rules_only | 0.957 | 0.367 | 0.530 | 0.017 | 0.633 | 0.055 | 0.94 |
| rules_classifier | 0.957 | 0.367 | 0.530 | 0.017 | 0.633 | 0.027 | 3.39 |
| full_stack | 0.957 | 0.367 | 0.530 | 0.017 | 0.633 | 0.027 | 3.51 |
...
| Chinese jailbreak | 0 | - | - | - |
| Chinese unsafe_prompt | 300 | 1.000 | 0.367 | 0.537 |
...
| 专项 | 样本数 | Precision | Recall | F1 |
| --- | --- | --- | --- | --- |
| exploit_or_attack_request | 29 | 1.000 | 0.552 | 0.711 |
...
| harmful_operational_guidance | 257 | 1.000 | 0.335 | 0.501 |
...
剩余中文 unsafe_prompt 漏报总数：`190`

classifier 高分但低证据：`16`

弱规则信号但未进 review：`0`

| 子类 | 数量 |
| --- | --- |
| exploit_or_attack_request | 13 |
| credential_or_data_theft | 2 |
| malware_or_privilege_escalation | 4 |
| harmful_operational_guidance | 171 |
