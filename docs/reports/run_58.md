# 评测报告 - zh_mixed_benchmark_v3_eval_v5
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| rules_only | 0.957 | 0.367 | 0.530 | 0.017 | 0.633 | 0.055 | 1.22 |
| rules_classifier | 0.965 | 0.460 | 0.623 | 0.017 | 0.540 | 0.062 | 4.74 |
| full_stack | 0.965 | 0.460 | 0.623 | 0.017 | 0.540 | 0.062 | 4.86 |
...
| Chinese jailbreak | 0 | - | - | - |
| Chinese unsafe_prompt | 300 | 1.000 | 0.460 | 0.630 |
...
| harmful_operational_guidance_unstructured | 223 | 1.000 | 0.350 | 0.518 |
...
剩余中文 unsafe_prompt 漏报总数：`162`

classifier 高分但低证据：`31`

规则命中但可执行性不足：`0`

harmful_operational_guidance 非结构化尾巴：`145`
