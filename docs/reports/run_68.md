# 评测报告 - zh_mixed_benchmark_v3_eval_v10
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| rules_only | 0.957 | 0.367 | 0.530 | 0.017 | 0.633 | 0.055 | 1.30 |
| rules_classifier | 0.966 | 0.477 | 0.638 | 0.017 | 0.523 | 0.063 | 9.06 |
| full_stack | 0.966 | 0.477 | 0.638 | 0.017 | 0.523 | 0.063 | 9.17 |
...
| Chinese jailbreak | 0 | - | - | - |
| Chinese unsafe_prompt | 300 | 1.000 | 0.477 | 0.646 |
...
| harmful_operational_guidance_unstructured | 223 | 1.000 | 0.372 | 0.542 |
...
剩余中文 unsafe_prompt 漏报总数：`157`

classifier 高分但低证据：`34`

规则命中但可执行性不足：`0`

harmful_operational_guidance 非结构化尾巴：`140`
