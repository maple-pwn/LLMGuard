...
class Sample(Base):
    ...
    source_dataset: Mapped[str | None] = mapped_column(String(128), nullable=True, index=True)
    source_split: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True)
    original_label: Mapped[str | None] = mapped_column(String(64), nullable=True)
    mapping_rule: Mapped[str | None] = mapped_column(String(64), nullable=True)
